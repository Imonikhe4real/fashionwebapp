...
class Register extends Connection{
  public function registration($firstname,$lastname,$email,$mobile,$username,$password,$confirmpassword,$address){
          ...
          if ($stmt->rowCount() > 0){
          	 ...
          	 if($password == $confirmpassword) {
          	  	   $result = "INSERT INTO users(firstname,lastname,email,mobile,username,password,address)VALUES(:firstname,:lastname,:email,:mobile,:username,:password,:address)";
          	  	   $stmt = $this->conn->prepare($result);
